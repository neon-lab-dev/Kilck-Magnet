...
const Page = ({ params }: PageProps) => {
  ...
  {
    label: "How DiaB Will Transform Infrastructure Monitoring and Maintenance",
    href: "#how-dia-b-will-transform-infrastructure-monitoring-and-maintenance",
  },
  { label: "The Future of Infrastructure Monitoring", href: "#future-of-infrastructure-monitoring" },
...
const descriptionContent = (
  <>
    <p id="drone-inspections">
      Infrastructure inspections are essential for maintaining the safety of assets like bridges, dams, and power lines. However, traditional methods face many challenges...
    </p>
    ...
    <p>
      Automated docked drone workflows offer a more efficient, scalable, and safer solution...
      Automated docked drone workflows offer a more efficient, scalable, and safer solution...
      Automated docked drone workflows offer a more efficient, scalable, and safer solution...
      Automated docked drone workflows offer a more efficient, scalable, and safer solution...
      Automated docked drone workflows offer a more efficient, scalable, and safer solution...
    ...
    <p>
      This approach enables organizations to conduct frequent, precise inspections with reduced risk...
      This approach enables organizations to conduct frequent, precise inspections with reduced risk...
      This approach enables organizations to conduct frequent, precise inspections with reduced risk...
      This approach enables organizations to conduct frequent, precise inspections with reduced risk...
      This approach enables organizations to conduct frequent, precise inspections with reduced risk...
  ...
  return (
    <div>
      <BlogDetailsHero />
       <BlogDescription tocItems={tocItems} descriptionContent={descriptionContent} />;
