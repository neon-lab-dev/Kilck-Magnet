...
const ContactUs = () => {
  return (
    <div className="bg-gradient-primary container-padding overflow-hidden font-Satoshi">
      <Container>
        <div className="flex flex-col xl:flex-row items-center gap-10 relative">
          <Image
            src={IMAGES.contactUsLines}
            alt=""
            className="absolute -top-0 md:-top-20 -right-32 overflow-hidden xl:-right-56 z-0 hidden xl:block"
          />
          <div className="w-full xl:w-[60%]">
            <h2 className="text-primary-20 text-lg 2xl:text-2xl font-black leading-8">
              CONTACT US
            </h2>
            <h1 className="text-white heading-xl mt-2 max-w-[770px]">
              We’re just a message away from starting something great together.
            </h1>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-7 md:gap-10 text-white font-normal md:font-medium text-sm md:text-base mt-16 2xl:mt-[116px]">
              <div className="flex flex-row md:flex-col gap-2 md:gap-0">
                <Image src={ICONS.phone} alt="" className="size-5" />
                <div className="flex items-center gap-1 mt-0 md:mt-[10px]">
              ...
              <div className="flex flex-row md:flex-col gap-2 md:gap-0">
                ...
                <a
                  ...
                  className="hover:underline mt-0 md:mt-[10px]"
                >
                  info@klickmagnet.in
                </a>
              </div>
              ...
              <div className="flex flex-row md:flex-col gap-2 md:gap-0">
                ...
                <p className="max-w-[368px] mt-0 md:mt-[10px]">
          ...
          <div className="w-full xl:w-[40%] z-10 bg-white p-4 md:p-6 rounded-[20px]">
            <ContactUsForm />
          </div>
        </div>
      </Container>
